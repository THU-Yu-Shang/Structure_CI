...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, skip_weight=1):
        super().__init__()
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, out_channels, num_blocks, stride):
        ...
        for stride in strides:
            layers.append(block(self.in_channels, out_channels, stride, self.w[t]))
...
def resnet34():
    ...
    return ResNet(BasicBlock, [3, 4, 6, 3], w)
